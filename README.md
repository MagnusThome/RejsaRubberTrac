...
A cheap wireless tire temperatures and suspension movement logger built from only a small cpu/bluetooth board plus a 16-zone temperature sensor and a distance sensor.
